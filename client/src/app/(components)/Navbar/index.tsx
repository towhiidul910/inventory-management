...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        {/* if the display size bigger then mideum then the display will be flex unless it will alowys will be hidden */}
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            <Bell cursor="cursor-pointer text-gray-500" size={24} />
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <Image
              src={
                "https://s3-inventorymanagement0.s3.us-east-2.amazonaws.com/profile.jpg"
              }
              alt="Profile"
              width={50}
              height={50}
